...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
            title="Required">Resource<wbr>Owner<span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
            title="Required">resource_<wbr>owner<span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>{{% md %}}The owner of the resource share. Valid values are SELF or OTHER-ACCOUNTS
{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
            title="">Resource<wbr>Owner<span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
            title="">resource_<wbr>owner<span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
