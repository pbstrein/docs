...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">Clusters</td>
            <td class="align-top">
                
                <code><a href="#instancecluster">List&lt;Instance<wbr>Cluster<wbr>Args&gt;?</a></code>
            </td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#instancecluster">[]Instance<wbr>Cluster</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
A block of cluster configuration options. This can be specified 1 or 2 times. See structure below.
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#instancecluster">List[Instance<wbr>Cluster]</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
A block of cluster configuration options. This can be specified 1 or 2 times. See structure below.
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A block of cluster configuration options. This can be specified 1 or 2 times. See structure below.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The human-readable display name of the Bigtable instance. Defaults to the instance `name`.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The instance type to create. One of `&#34;DEVELOPMENT&#34;` or `&#34;PRODUCTION&#34;`. Defaults to `&#34;PRODUCTION&#34;`.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name (also called Instance Id in the Cloud Console) of the Cloud Bigtable instance.
 {{% /md %}}
...
{{% lang csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.Gcp/Pulumi.Gcp.Bigtable.InstanceClusterArgs.html">input</a> and <a href="/docs/reference/pkg/dotnet/Pulumi.Gcp/Pulumi.Gcp.Bigtable.InstanceCluster.html">output</a> API doc for this type.
{{% /lang %}}
