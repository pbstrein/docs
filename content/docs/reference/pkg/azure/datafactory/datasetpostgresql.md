...
Creates a DatasetPostgresql resource with the given unique name, arguments, and options.
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#datasetpostgresqlschemacolumn">List&lt;Dataset<wbr>Postgresql<wbr>Schema<wbr>Column<wbr>Args&gt;?</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#datasetpostgresqlschemacolumn">[]Dataset<wbr>Postgresql<wbr>Schema<wbr>Column</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
A `schema_column` block as defined below.
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#datasetpostgresqlschemacolumn">List[Dataset<wbr>Postgresql<wbr>Schema<wbr>Column]</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
A `schema_column` block as defined below.
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A map of additional properties to associate with the Data Factory Dataset PostgreSQL.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} List of tags that can be used for describing the Data Factory Dataset PostgreSQL.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The description for the Data Factory Dataset PostgreSQL.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Specifies the name of the Data Factory Dataset PostgreSQL. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A map of parameters to associate with the Data Factory Dataset PostgreSQL.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the resource group in which to create the Data Factory Dataset PostgreSQL. Changing this forces a new resource
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The table name of the Data Factory Dataset PostgreSQL.
 {{% /md %}}
...
{{% lang csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.Datafactory.DatasetPostgresqlSchemaColumnArgs.html">input</a> and <a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.Datafactory.DatasetPostgresqlSchemaColumn.html">output</a> API doc for this type.
{{% /lang %}}
