...
Creates a BillingAccountSink resource with the given unique name, arguments, and options.
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#billingaccountsinkbigqueryoptions">Billing<wbr>Account<wbr>Sink<wbr>Bigquery<wbr>Options<wbr>Args?</a></code>
            </td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#billingaccountsinkbigqueryoptions">*Billing<wbr>Account<wbr>Sink<wbr>Bigquery<wbr>Options</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
Options that affect sinks exporting data to BigQuery. Structure documented below.
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#billingaccountsinkbigqueryoptions">Dict[Billing<wbr>Account<wbr>Sink<wbr>Bigquery<wbr>Options]</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
Options that affect sinks exporting data to BigQuery. Structure documented below.
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The billing account exported to the sink.
 {{% /md %}}
...
{{% lang csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.Gcp/Pulumi.Gcp.Logging.BillingAccountSinkBigqueryOptionsArgs.html">input</a> and <a href="/docs/reference/pkg/dotnet/Pulumi.Gcp/Pulumi.Gcp.Logging.BillingAccountSinkBigqueryOptions.html">output</a> API doc for this type.
{{% /lang %}}
