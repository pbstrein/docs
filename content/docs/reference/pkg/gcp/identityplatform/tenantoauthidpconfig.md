...
Creates a TenantOauthIdpConfig resource with the given unique name, arguments, and options.
...
If it is not provided, the provider project is used.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the tenant where this OIDC IDP configuration resource exists
 {{% /md %}}
