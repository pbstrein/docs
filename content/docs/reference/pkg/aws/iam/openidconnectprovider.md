...
<dl class="resources-properties">
    ...
    <dt class="property-required"
            title="Required">Client<wbr>Id<wbr>Lists<span class="property-indicator"></span>
...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
            title="Required">Thumbprint<wbr>Lists<span class="property-indicator"></span>
        <span class="property-type">List<string></span>
    </dt>
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
            title="Required">client_<wbr>id_<wbr>lists<span class="property-indicator"></span>
...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
            title="Required">thumbprint_<wbr>lists<span class="property-indicator"></span>
        <span class="property-type">List[str]</span>
    </dt>
    <dd>{{% md %}}A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider&#39;s server certificate(s). 
{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
            title="">Client<wbr>Id<wbr>Lists<span class="property-indicator"></span>
        <span class="property-type">List<string></span>
    </dt>
    <dd>{{% md %}}A list of client IDs (also known as audiences). When a mobile or web app registers with an OpenID Connect provider, they establish a value that identifies the application. (This is the value that&#39;s sent as the client_id parameter on OAuth requests.)
{{% /md %}}</dd>
    ...
    <dt class="property-"
            title="">Thumbprint<wbr>Lists<span class="property-indicator"></span>
        <span class="property-type">List<string></span>
    </dt>
    <dd>{{% md %}}A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider&#39;s server certificate(s). 
{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
            title="">client_<wbr>id_<wbr>lists<span class="property-indicator"></span>
        <span class="property-type">List[str]</span>
    </dt>
    <dd>{{% md %}}A list of client IDs (also known as audiences). When a mobile or web app registers with an OpenID Connect provider, they establish a value that identifies the application. (This is the value that&#39;s sent as the client_id parameter on OAuth requests.)
{{% /md %}}</dd>
    ...
    <dt class="property-"
            title="">thumbprint_<wbr>lists<span class="property-indicator"></span>
        <span class="property-type">List[str]</span>
    </dt>
    <dd>{{% md %}}A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider&#39;s server certificate(s). 
{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">Client<wbr>Id<wbr>Lists<span class="property-indicator"></span>
        <span class="property-type">List<string>?</span>
    </dt>
    <dd>{{% md %}}A list of client IDs (also known as audiences). When a mobile or web app registers with an OpenID Connect provider, they establish a value that identifies the application. (This is the value that&#39;s sent as the client_id parameter on OAuth requests.)
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">Thumbprint<wbr>Lists<span class="property-indicator"></span>
        <span class="property-type">List<string>?</span>
    </dt>
    <dd>{{% md %}}A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider&#39;s server certificate(s). 
{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">client_<wbr>id_<wbr>lists<span class="property-indicator"></span>
        <span class="property-type">List[str]</span>
    </dt>
    <dd>{{% md %}}A list of client IDs (also known as audiences). When a mobile or web app registers with an OpenID Connect provider, they establish a value that identifies the application. (This is the value that&#39;s sent as the client_id parameter on OAuth requests.)
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">thumbprint_<wbr>lists<span class="property-indicator"></span>
        <span class="property-type">List[str]</span>
    </dt>
    <dd>{{% md %}}A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider&#39;s server certificate(s). 
{{% /md %}}</dd>
