...
Creates a AnalyticsSolution resource with the given unique name, arguments, and options.
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#analyticssolutionplan">Analytics<wbr>Solution<wbr>Plan<wbr>Args</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Required)
...
The name of the resource group in which the Log Analytics solution is created. Changing this forces a new resource to be created. Note: The solution and it&#39;s related workspace can only exist in the same resource group.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Solution<wbr>Name</td>
            <td class="align-top">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#analyticssolutionplan">Analytics<wbr>Solution<wbr>Plan</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Required)
A `plan` block as documented below.
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#analyticssolutionplan">Dict[Analytics<wbr>Solution<wbr>Plan]</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Required)
A `plan` block as documented below.
...
The name of the resource group in which the Log Analytics solution is created. Changing this forces a new resource to be created. Note: The solution and it&#39;s related workspace can only exist in the same resource group.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">solution_<wbr>name</td>
            <td class="align-top">
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the resource group in which the Log Analytics solution is created. Changing this forces a new resource to be created. Note: The solution and it&#39;s related workspace can only exist in the same resource group.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Specifies the name of the solution to be deployed. See [here for options](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-add-solutions).Changing this forces a new resource to be created.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The full name of the Log Analytics workspace with which the solution will be linked. Changing this forces a new resource to be created.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The full resource ID of the Log Analytics workspace with which the solution will be linked. Changing this forces a new resource to be created.
 {{% /md %}}
...
{{% lang csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.Operationalinsights.AnalyticsSolutionPlanArgs.html">input</a> and <a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.Operationalinsights.AnalyticsSolutionPlan.html">output</a> API doc for this type.
{{% /lang %}}
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Promotion<wbr>Code</td>
            <td class="align-top">
