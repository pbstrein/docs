...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
            title="Required">Rule<wbr>Type<span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">Target<wbr>Ips<span class="property-indicator"></span>
...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
            title="Required">rule_<wbr>type<span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>{{% md %}}The rule type. Valid values are `FORWARD`, `SYSTEM` and `RECURSIVE`.
{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">target_<wbr>ips<span class="property-indicator"></span>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
            title="">Target<wbr>Ips<span class="property-indicator"></span>
        <span class="property-type"><a href="#resolverruletargetip">List&lt;Resolver<wbr>Rule<wbr>Target<wbr>Ip&gt;?</a></span>
    </dt>
    <dd>{{% md %}}Configuration block(s) indicating the IPs that you want Resolver to forward DNS queries to (documented below).
This argument should only be specified for `FORWARD` type rules.
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
            title="">target_<wbr>ips<span class="property-indicator"></span>
        <span class="property-type"><a href="#resolverruletargetip">List[Resolver<wbr>Rule<wbr>Target<wbr>Ip]</a></span>
    </dt>
    <dd>{{% md %}}Configuration block(s) indicating the IPs that you want Resolver to forward DNS queries to (documented below).
This argument should only be specified for `FORWARD` type rules.
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">Share<wbr>Status<span class="property-indicator"></span>
        <span class="property-type">string?</span>
    </dt>
    <dd>{{% md %}}Whether the rules is shared and, if so, whether the current account is sharing the rule with another account, or another account is sharing the rule with the current account.
Values are `NOT_SHARED`, `SHARED_BY_ME` or `SHARED_WITH_ME`
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">share_<wbr>status<span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>{{% md %}}Whether the rules is shared and, if so, whether the current account is sharing the rule with another account, or another account is sharing the rule with the current account.
Values are `NOT_SHARED`, `SHARED_BY_ME` or `SHARED_WITH_ME`
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
            title="Required">Ip<span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
