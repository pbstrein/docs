...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
            title="Optional">Byte<wbr>Match<wbr>Tuples<span class="property-indicator"></span>
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
            title="Optional">byte_<wbr>match_<wbr>tuples<span class="property-indicator"></span>
...
<dl class="resources-properties">
    ...
    <dt class="property-"
            title="">Byte<wbr>Match<wbr>Tuples<span class="property-indicator"></span>
        <span class="property-type"><a href="#bytematchsetbytematchtuple">List&lt;Byte<wbr>Match<wbr>Set<wbr>Byte<wbr>Match<wbr>Tuple&gt;?</a></span>
    </dt>
    <dd>{{% md %}}Settings for the ByteMatchSet, such as the bytes (typically a string that corresponds with ASCII characters) that you want AWS WAF to search for in web requests. ByteMatchTuple documented below.
{{% /md %}}</dd>
...
<dl class="resources-properties">
    ...
    <dt class="property-"
            title="">byte_<wbr>match_<wbr>tuples<span class="property-indicator"></span>
        <span class="property-type"><a href="#bytematchsetbytematchtuple">List[Byte<wbr>Match<wbr>Set<wbr>Byte<wbr>Match<wbr>Tuple]</a></span>
    </dt>
    <dd>{{% md %}}Settings for the ByteMatchSet, such as the bytes (typically a string that corresponds with ASCII characters) that you want AWS WAF to search for in web requests. ByteMatchTuple documented below.
{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
            title="Required">Positional<wbr>Constraint<span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">Target<wbr>String<span class="property-indicator"></span>
        <span class="property-type">string?</span>
    </dt>
